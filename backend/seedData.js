    ...
    ,
        {
          ...
          description: 'Aromatic basmati rice layered with spiced chicken pieces, herbs and saffron.',
          price: 330.00,
          category: 'Mains',
          image: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=600&auto=format&fit=crop',
          tags: ['Spicy', 'Classic'],
        ...
        {
          name: 'Pav Bhaji',
          description: 'Spicy mixed vegetable mash served with buttered pav.',
          price: 140.00,
          category: 'Mains',
          image: 'https://images.unsplash.com/photo-1646057922171-456c51e71a6c?w=600&auto=format&fit=crop',
        ...
        },
        {
          ...
          description: 'Crispy cauliflower florets tossed in Indo‑Chinese spicy sauce.',
          price: 180.00,
          category: 'Chef Specials',
          image: 'https://images.unsplash.com/photo-1594956270935-2ac0a847fbd5?w=600&auto=format&fit=crop',
          tags: ['Indo-Chinese', 'Spicy'],
          dietaryType: 'veg',
          allergens: [],
          ingredients: ['Cauliflower', 'Cornstarch', 'Soy sauce', 'Chilli', 'Garlic'],
          calories: 350,
          prepTime: 15,
          isAvailable: true,
          reviews: [],
        ...
        },
        {
          ...
          price: 190.00,
          category: 'Mains',
          image: 'https://images.unsplash.com/photo-1586773860412-17d5143e4c70?w=600&auto=format&fit=crop',
        ...
        {
          name: 'Rajma Chawal',
          description: 'Kidney beans simmered in rich tomato gravy served with steamed rice.',
          price: 150.00,
          category: 'Mains',
          image: 'https://images.unsplash.com/photo-1581349422464-9ae81e9c1a43?w=600&auto=format&fit=crop',
        ...
        {
          name: 'Idli Sambhar',
          description: 'Steamed rice cakes served with flavorful lentil stew.',
          price: 110.00,
          category: 'Starters',
          image: 'https://images.unsplash.com/photo-1628007465317-0af7d1bb8b5b?w=600&auto=format&fit=crop',
          tags: ['South Indian', 'Breakfast'],
          dietaryType: 'veg',
          allergens: [],
          ingredients: ['Rice', 'Urad dal', 'Sambhar', 'Coconut'],
          calories: 250,
          prepTime: 20,
          isAvailable: true,
          reviews: [],
        ...
        },
        {
          ...
          description: 'Cottage cheese cubes in a creamy tomato butter sauce.',
          price: 260.00,
          category: 'Mains',
          image: 'https://images.unsplash.com/photo-1654779006990-5432c6680b2c?w=600&auto=format&fit=crop',
        ...
        {
          name: 'Chicken Tikka',
          description: 'Tender chicken chunks marinated in spices and grilled.',
          price: 280.00,
          category: 'Starters',
          image: 'https://images.unsplash.com/photo-1604023424685-69f5e1cd-208?w=600&auto=format&fit=crop',
          tags: ['Grilled', 'Non-Veg'],
          dietaryType: 'non-veg',
          allergens: [],
        ...
        {
          name: 'Malai Kofta',
          description: 'Deep-fried cottage cheese and potato dumplings served in a rich, creamy cashew gravy.',
          price: 270.00,
          category: 'Mains',
          ...
          dietaryType: 'veg',
          allergens: ['Dairy', 'Nuts'],
          ingredients: ['Paneer', 'Potatoes', 'Cashews', 'Cream', 'Spices'],
          calories: 580,
          prepTime: 20,
          isAvailable: true,
          reviews: [],
        ...
        },
        {
          ...
          description: 'Tandoor-baked Indian flatbread topped with minced fresh garlic, coriander, and melted butter.',
          price: 55.00,
          category: 'Starters',
          image: 'https://images.unsplash.com/photo-1601050690597-df056fb4ce78?w=600&auto=format&fit=crop',
        ...
        },
        {
          ...
          description: 'Kashmiri delicacy of tender lamb braised in a gravy flavored with garlic, ginger and aromatic spices.',
          price: 420.00,
          category: 'Mains',
          ...
          dietaryType: 'non-veg',
          allergens: [],
          ingredients: ['Mutton', 'Kashmiri chilli', 'Yogurt', 'Fennel', 'Spices'],
          calories: 610,
          prepTime: 25,
          isAvailable: true,
          reviews: [],
        ...
        },
        {
          ...
          description: 'Traditional sweet yogurt drink blended with cardamom, topped with rabri and dry fruits.',
          price: 80.00,
          category: 'Beverages',
          image: 'https://images.unsplash.com/photo-1553530666-ba11a7da3888?w=600&auto=format&fit=crop',
        ...
        },
        {
          ...
          description: 'Steaming hot aromatic Indian spiced tea served in traditional clay cups (kulhad).',
          price: 45.00,
          category: 'Beverages',
          image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=600&auto=format&fit=crop',
          tags: ['Hot', 'Traditional'],
        ...
        },
        {
          ...
          description: 'Classic Indian sweet made from cashew nuts, sugar, and edible silver foil.',
          price: 110.00,
          category: 'Desserts',
          image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=600&auto=format&fit=crop',
        ...
        },
        {
          ...
          description: 'Deep-fried chicken appetizer marinated with red chillies, curry leaves, and ginger-garlic paste.',
          price: 260.00,
          category: 'Starters',
          image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&auto=format&fit=crop',
