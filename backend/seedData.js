...
const seed = async () => {
  ...
  try {
    ...
    const itemsData = [
      ...
      {
        name: 'Masala Dosa',
        description: 'Crispy fermented rice and lentil crepe filled with spiced potato masala, served with coconut chutney and hot sambhar.',
        price: 120.00,
        category: 'Starters',
        image: 'https://images.unsplash.com/photo-1589282389367-7ffd9b6d73a2?w=600&auto=format&fit=crop',
        tags: ['Vegetarian', 'South Indian'],
        dietaryType: 'veg',
        allergens: ['Gluten'],
        ingredients: ['Rice', 'Urad dal', 'Potatoes', 'Spices', 'Oil', 'Coconut chutney'],
        calories: 300,
        prepTime: 15,
        isAvailable: true,
        reviews: [],
      ...
      {
        name: 'Idli Sambhar',
        description: 'Soft, pillowy steamed rice cakes served with flavorful tamarind-spiced lentil stew and fresh coconut chutney.',
        price: 110.00,
        category: 'Starters',
        ...
        dietaryType: 'veg',
        allergens: [],
        ingredients: ['Rice', 'Urad dal', 'Sambhar', 'Coconut', 'Mustard seeds'],
        calories: 250,
        prepTime: 20,
        isAvailable: true,
        reviews: [],
      ...
      {
        name: 'Chicken Tikka',
        description: 'Succulent chicken chunks marinated in yoghurt, ginger-garlic paste, and aromatic spices, then grilled to perfection in a tandoor.',
        price: 280.00,
        category: 'Starters',
        image: 'https://images.unsplash.com/photo-1610057099431-d73a1c9d2f2f?w=600&auto=format&fit=crop',
        tags: ['Grilled', 'Non-Veg', 'Best Seller'],
        dietaryType: 'non-veg',
        allergens: ['Dairy'],
        ...
        isAvailable: true,
        reviews: [
          { customerName: 'Amit S.', rating: 5, comment: 'Best chicken tikka I have ever had!' }
        ],
        averageRating: 5.0
      },
      {
        name: 'Spicy Chicken 65',
        description: 'Deep-fried, fiery chicken appetizer marinated with red chillies, fresh curry leaves, and ginger-garlic paste. A South Indian classic.',
        price: 260.00,
        category: 'Starters',
        image: 'https://images.unsplash.com/photo-1626777552726-4a6b54c97e46?w=600&auto=format&fit=crop',
        tags: ['South Indian', 'Spicy', 'Non-Veg'],
        dietaryType: 'non-veg',
        allergens: [],
        ingredients: ['Chicken', 'Curry leaves', 'Chilli paste', 'Cornstarch', 'Garlic'],
        calories: 410,
        prepTime: 15,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Tandoor-baked soft Indian flatbread generously topped with minced fresh garlic, chopped coriander, and melted butter. Perfect with any curry.',
        price: 55.00,
        category: 'Starters',
        image: 'https://images.unsplash.com/photo-1585039776629-8b9ec7db789d?w=600&auto=format&fit=crop',
        tags: ['Bread', 'Vegetarian', 'Popular'],
        dietaryType: 'veg',
      ...
      },
      {
        ...
        description: 'Fragrant basmati rice layered with marinated tender chicken, saffron, caramelized onions, and whole spices. Served with cooling raita.',
        price: 330.00,
        category: 'Mains',
        image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=600&auto=format&fit=crop',
        tags: ['Spicy', 'Classic', 'Non-Veg'],
        dietaryType: 'non-veg',
        allergens: ['Dairy'],
        ingredients: ['Chicken', 'Basmati rice', 'Saffron', 'Spices', 'Onion', 'Yogurt'],
        calories: 650,
        prepTime: 25,
        isAvailable: true,
        reviews: [],
      ...
      {
        name: 'Pav Bhaji',
        description: 'Mumbai street food classic: a thick, spicy mixed vegetable mash cooked with butter and served with soft, toasted buttered pav buns.',
        price: 140.00,
        category: 'Mains',
        ...
        dietaryType: 'veg',
        allergens: ['Gluten', 'Dairy'],
        ingredients: ['Potatoes', 'Peas', 'Cauliflower', 'Tomato', 'Butter', 'Pav bread'],
        calories: 500,
        prepTime: 20,
        isAvailable: true,
        reviews: [],
      ...
      {
        name: 'Chole Bhature',
        description: 'North Indian classic: perfectly spiced Punjabi chickpea curry served with fluffy, golden deep-fried bhature. Garnished with onions and green chilli.',
        price: 190.00,
        category: 'Mains',
      ...
      {
        name: 'Rajma Chawal',
        description: 'Comfort food at its finest: hearty kidney beans simmered in a rich, spiced tomato-onion gravy, served with perfectly steamed basmati rice.',
        price: 150.00,
        category: 'Mains',
      ...
      },
      {
        ...
        description: 'Fresh cottage cheese cubes slow-cooked in a silky smooth, mildly spiced tomato-butter sauce with aromatic cardamom and kasuri methi.',
        price: 260.00,
        category: 'Mains',
        ...
        dietaryType: 'veg',
        allergens: ['Dairy'],
        ingredients: ['Paneer', 'Tomato', 'Butter', 'Cream', 'Spices', 'Kasuri methi'],
        calories: 540,
        prepTime: 15,
        isAvailable: true,
        reviews: [],
      ...
      {
        name: 'Malai Kofta',
        description: 'Melt-in-your-mouth deep-fried cottage cheese and potato dumplings, served in a rich, creamy, mildly sweet cashew-tomato gravy.',
        price: 270.00,
        category: 'Mains',
        image: 'https://images.unsplash.com/photo-1674684938469-5ef8c8e4e0b9?w=600&auto=format&fit=crop',
        tags: ['Rich', 'Vegetarian', 'Royal'],
        dietaryType: 'veg',
        allergens: ['Dairy', 'Nuts'],
        ingredients: ['Paneer', 'Potatoes', 'Cashews', 'Cream', 'Spices', 'Tomato'],
        calories: 580,
        prepTime: 20,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Kashmiri heritage dish: succulent tender lamb braised in a deeply aromatic gravy with whole spices, Kashmiri chilli, and fennel.',
        price: 420.00,
        category: 'Mains',
        image: 'https://images.unsplash.com/photo-1545247181-516773cae754?w=600&auto=format&fit=crop',
        tags: ['Spicy', 'Kashmiri', 'Non-Veg'],
        dietaryType: 'non-veg',
        allergens: [],
        ingredients: ['Mutton', 'Kashmiri chilli', 'Yogurt', 'Fennel', 'Spices', 'Ginger'],
        calories: 610,
        prepTime: 25,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Classic Indian mithai made from finely ground cashew nuts, sugar, and edible silver foil (varak). Rich, melt-in-mouth texture.',
        price: 110.00,
        category: 'Desserts',
        image: 'https://images.unsplash.com/photo-1666032167283-4abe5c17d71f?w=600&auto=format&fit=crop',
      ...
      {
        name: 'Gajar Ka Halwa',
        description: 'Slow-cooked grated carrot dessert simmered in full-fat milk, sugar, ghee, and cardamom. Topped with roasted almonds and cashews. Served warm.',
        price: 130.00,
        category: 'Desserts',
        image: 'https://images.unsplash.com/photo-1678838096620-54fbe9b00f51?w=600&auto=format&fit=crop',
        tags: ['Sweet', 'Winter Special', 'Traditional'],
        dietaryType: 'veg',
        allergens: ['Dairy', 'Nuts'],
        ingredients: ['Carrots', 'Milk', 'Sugar', 'Ghee', 'Cardamom', 'Almonds', 'Cashews'],
        calories: 360,
        prepTime: 6,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Freshly brewed strong Indian black tea leaves boiled with milk, crushed fresh ginger (adrak), and aromatic cardamom pods (elaichi). Served piping hot.',
        price: 50.00,
        category: 'Beverages',
      ...
      },
      {
        ...
        description: 'Traditional Punjabi sweet yogurt drink blended with green cardamom, topped with thick malai (rabri) and assorted dry fruits.',
        price: 80.00,
        category: 'Beverages',
        image: 'https://images.unsplash.com/photo-1567327613485-fbc7bf196198?w=600&auto=format&fit=crop',
        tags: ['Refreshing', 'Sweet', 'Cold'],
        dietaryType: 'veg',
        allergens: ['Dairy', 'Nuts'],
        ingredients: ['Yogurt', 'Sugar', 'Cardamom', 'Almonds', 'Pistachios'],
        calories: 220,
        prepTime: 5,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Chilled sparkling soda water with freshly squeezed lime juice, black salt, and roasted cumin powder. Sweet or salted as you prefer.',
        price: 60.00,
        category: 'Beverages',
        image: 'https://images.unsplash.com/photo-1541614101331-1a5a3a194e92?w=600&auto=format&fit=crop',
        tags: ['Refreshing', 'Cold', 'Mocktail'],
        dietaryType: 'vegan',
        allergens: [],
        ingredients: ['Lime juice', 'Soda water', 'Black salt', 'Cumin', 'Sugar'],
        calories: 50,
        prepTime: 3,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'Restaurant-style crispy cauliflower florets coated in spiced batter and tossed in a bold Indo-Chinese sauce with garlic, ginger, and green chillies.',
        price: 180.00,
        category: 'Chef Specials',
        ...
        dietaryType: 'veg',
        allergens: ['Gluten', 'Soy'],
        ingredients: ['Cauliflower', 'Cornstarch', 'Soy sauce', 'Chilli', 'Garlic', 'Ginger'],
        calories: 350,
        prepTime: 15,
        isAvailable: true,
        reviews: [],
      ...
      },
      {
        ...
        description: 'A spectacular sharing platter of tandoori chicken, seekh kebab, paneer tikka, and hariyali prawns with mint chutney, sliced onion, and lemon wedges.',
        price: 580.00,
        category: 'Chef Specials',
        image: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&auto=format&fit=crop',
        tags: ['Sharing', 'Mixed', 'Grilled', 'Chef Pick'],
        dietaryType: 'non-veg',
        allergens: ['Dairy', 'Shellfish'],
        ingredients: ['Chicken', 'Mutton mince', 'Paneer', 'Prawns', 'Yogurt', 'Spices'],
        calories: 980,
        prepTime: 25,
        isAvailable: true,
        reviews: [
          { customerName: 'Kavya R.', rating: 5, comment: 'The best platter experience. Every piece was juicy and flavorful!' }
        ],
        averageRating: 5.0
      }
    ];
